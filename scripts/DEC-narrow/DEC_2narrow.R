...
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
trfn = "carex-all-0.001-dated-ultrametric-2017-08-02.newick"
...
# (from Ree & Smith 2008)
geogfn = "carex-two-regions-narrow.data"
...
runslow = TRUE
resfn = "carex_all_DEC_narrow_2regions-unconstrained.Rdata"
if (runslow)
    {
...
#######################################################
pdffn = paste0("carex_2regions-", model_name, "_DEC.pdf")
pdf(pdffn, width=15, height=80)
